...
INVITE_HANDLER = DisableAbleCommandHandler("invitelink", invite, filters=Filters.group, run_async=True)
...
SET_TITLE_HANDLER = CommandHandler("settitle", set_title, pass_args=True, run_async=True)
