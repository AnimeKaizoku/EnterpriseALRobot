...
kigcmd = ZhongliTelegramHandler(d).command
kigmsg = ZhongliTelegramHandler(d).message
kigcallback = ZhongliTelegramHandler(d).callbackquery
kiginline = ZhongliTelegramHandler(d).inlinequery
