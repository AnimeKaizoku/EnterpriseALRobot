...
from telegram.ext import CommandHandler, DispatcherHandlerStop, MessageHandler, Filters, CallbackQueryHandler, CallbackContext
...
def warn(
    ...
    if num_warns >= limit:
        ...
        message.bot.send_sticker(chat.id, BAN_STICKER)  # Kigyo's sticker
        keyboard = []
        log_reason = (
