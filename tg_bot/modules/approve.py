...
APPROVE = DisableAbleCommandHandler("approve", approve, filters=Filters.group, run_async=True)
DISAPPROVE = DisableAbleCommandHandler("unapprove", disapprove, filters=Filters.group, run_async=True)
APPROVED = DisableAbleCommandHandler("approved", approved, filters=Filters.group, run_async=True)
APPROVAL = DisableAbleCommandHandler("approval", approval, filters=Filters.group, run_async=True)
UNAPPROVEALL = DisableAbleCommandHandler("unapproveall", unapproveall, filters=Filters.group, run_async=True)
